import { getDriveOAuthStatus, json, normalizeShopId, readShopStorageToken } from './_shared.mjs'
...
export const handler = async (event) => {
  ...
  try {
    ...
    return json(200, await getDriveOAuthStatus({ shopId }))
  } catch (error) {
    return json(400, { ok: false, error: error instanceof Error ? error.message : 'Unable to load Drive status.' })
  }
}
